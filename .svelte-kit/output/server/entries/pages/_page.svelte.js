import { c as create_ssr_component, s as setContext, o as onDestroy, v as validate_component } from "../../chunks/ssr.js";
import Page$2 from "./Add_Container/_page.svelte.js";
import Page$3 from "./Products_Container/_page.svelte.js";
import Page$1 from "./Header/_page.svelte.js";
import { i as isValidTimeout, f as functionalUpdate, r as replaceEqualDeep, n as noop, t as timeUntilStale, e as ensureQueryKeyArray, g as getAbortController, R as Retryer, a as isCancelledError, b as getLogger, c as notifyManager, S as Subscribable, h as hashQueryKeyByOptions, p as parseFilterArgs, m as matchQuery, M as Mutation, d as matchMutation, j as isCancelable, k as focusManager, o as onlineManager, l as parseQueryArgs, q as hashQueryKey, s as partialMatchKey } from "../../chunks/_page.js";
class Query {
  constructor(config) {
...
const css = {
  code: ".mainContainer.svelte-kjgcjw{margin-top:2em;padding:0 2em 2em;position:relative}",
  map: null
};
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(QueryClientProvider$1, "QueryClientProvider").$$render($$result, { client: queryClient }, {}, {
    default: () => {
      return `${validate_component(Page$1, "Header").$$render($$result, {}, {}, {})} <div class="mainContainer svelte-kjgcjw">${validate_component(Page$2, "AddContainer").$$render($$result, {}, {}, {})} ${validate_component(Page$3, "ProductContainer").$$render($$result, {}, {}, {})}</div>`;
    }
  })}`;
});
export {
